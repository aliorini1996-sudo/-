...
const FALLBACK = {
  plans: [
    { name: 'المبتدئة', price: '299', limit: 'حتى ٥ مناديب · مستخدم إداري واحد' },
    { name: 'المتوسطة', price: '399', limit: 'حتى ١٠ مناديب · مستخدمان إداريان' },
    { name: 'المتقدمة', price: '599', limit: 'حتى ٢٠ مندوبًا · ٥ مستخدمين إداريين' },
