...
export const defaultContentEn = {
  ...
  pages: {
    ...
    terms: {
      ...
      body: 'By using the Field Sales platform you agree to these terms. The service is provided as-is for field sales management. The subscriber is responsible for protecting their login credentials and using the system for lawful purposes only. We reserve the right to modify the service or pricing with prior notice.',
    },
    serviceAgreement: {
      title: 'Service Agreement',
      body: 'This agreement outlines the scope of the Field Sales service and its availability and support level. We are committed to the security of your data and isolating it per company. The service includes periodic updates and technical support via info@fieldsa.net.',
    },
    privacy: {
      title: 'Privacy Policy',
      body: 'We respect your privacy. Your data is collected solely to operate the service and is never shared with any third party. Each company has its fully isolated space, and connections are encrypted. You may request deletion of your data at any time via info@fieldsa.net.',
    },
  },
