// ============================================================================
// نسخة حرفية من backend/src/compliance/zatca/validators.ts (بعد رأسه) — مُدقِّقات بيانات البائع والمشتري للفوترة الإلكترونية.
// لا تعدّل هنا: عدّل ملف الخادم ثم انسخه. الحارس lib/zatca/validators.test.ts يفشل عند أي فرق.
// ============================================================================
