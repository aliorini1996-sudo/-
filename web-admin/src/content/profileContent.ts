 ...
 *
 * ⚠️ **لماذا مفتاح جديد لا `profile`:** أسماء حقول العرض الجديد تشارك القديمة
 * في كثير منها (`cover_title` و`problem_title` و`solution_title` …)، و`mergeProfile`
 * يُعلي المحفوظ على الافتراضي. فبقيت في القاعدة ٢٧ قيمة من البروفايل القديم
 * تفوز على نصوص العرض الجديد بصمت — فيرى الزائر عناوين قديمة داخل تصميم جديد،
 * ولا شيء في الكود يُنبّه.
 *
 * والدرس: **تغيير مجموعة المحتوى يلزمه فضاء اسم جديد**، وإلا فازت قيمٌ محفوظة
 * لمعنى آخر. والقديم يبقى في `profile` كما هو — لا يُحذف ولا يُقرأ.
 */
export const PROFILE_CMS_KEY = 'profileV2';
