...
const DICT = {
  ...
  'f.phoneHint': { ar: 'جوال سعودي، مثل 05XXXXXXXX', en: 'Saudi mobile, e.g. 05XXXXXXXX', fr: 'Mobile saoudien, ex. 05XXXXXXXX', tr: 'Suudi cep numarası, ör. 05XXXXXXXX', zh: '沙特手机号，例如 05XXXXXXXX' },
  ...
  'val.phone': { ar: 'أدخل رقم جوال سعودي صحيح يبدأ بـ05', en: 'Enter a valid Saudi mobile number starting with 05', fr: 'Saisissez un mobile saoudien valide commençant par 05', tr: '05 ile başlayan geçerli bir Suudi cep numarası girin', zh: '请输入以 05 开头的有效沙特手机号' },
