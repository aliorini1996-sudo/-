...
const TOPICS = [
  ...
  { id: 'wholesale-food-distributors', cs: true, rm: 6,
    label: svc('حلول موزّعي المواد الغذائية والجملة', 'Food, Dairy & Wholesale Distribution Solutions', 'Solutions pour la distribution alimentaire, laitière et de gros'),
