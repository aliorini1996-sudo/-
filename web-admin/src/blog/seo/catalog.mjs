...
export const COUNTRIES = [
  { code: 'SA', ar: 'السعودية', en: 'Saudi Arabia', fr: 'Arabie saoudite', inAr: 'في السعودية', inEn: 'in Saudi Arabia', inFr: 'en Arabie saoudite', cap: { ar: 'الرياض', en: 'Riyadh', fr: 'Riyad' }, cities: [{ ar: 'جدة', en: 'Jeddah', fr: 'Djeddah' }, { ar: 'الدمام', en: 'Dammam', fr: 'Dammam' }], cur: { ar: 'الريال السعودي', en: 'Saudi Riyal (SAR)', fr: 'le riyal saoudien' }, vat: 15, tax: { ar: 'هيئة الزكاة والضريبة والجمارك ZATCA', en: 'ZATCA', fr: 'la ZATCA' }, einv: { ar: 'الفوترة الإلكترونية فاتورة مطبقة على مرحلتين', en: 'ZATCA e-invoicing (Fatoora) is mandatory in two phases', fr: 'la facturation électronique ZATCA (Fatoora) est obligatoire' } },
  { code: 'EG', ar: 'مصر', en: 'Egypt', fr: 'Égypte', inAr: 'في مصر', inEn: 'in Egypt', inFr: 'en Égypte', cap: { ar: 'القاهرة', en: 'Cairo', fr: 'Le Caire' }, cities: [{ ar: 'الإسكندرية', en: 'Alexandria', fr: 'Alexandrie' }, { ar: 'الجيزة', en: 'Giza', fr: 'Gizeh' }], cur: { ar: 'الجنيه المصري', en: 'Egyptian Pound (EGP)', fr: 'la livre égyptienne' }, vat: 14, tax: { ar: 'مصلحة الضرائب المصرية ETA', en: 'the Egyptian Tax Authority (ETA)', fr: "l'Autorité fiscale égyptienne (ETA)" }, einv: { ar: 'الفاتورة والإيصال الإلكتروني إلزاميان تدريجيا', en: 'e-invoice and e-receipt are being enforced', fr: 'la facture et le reçu électroniques sont progressivement obligatoires' } },
  ...
  { code: 'BH', ar: 'البحرين', en: 'Bahrain', fr: 'Bahreïn', inAr: 'في البحرين', inEn: 'in Bahrain', inFr: 'au Bahreïn', cap: { ar: 'المنامة', en: 'Manama', fr: 'Manama' }, cities: [{ ar: 'المحرق', en: 'Muharraq', fr: 'Muharraq' }, { ar: 'الرفاع', en: 'Riffa', fr: 'Riffa' }], cur: { ar: 'الدينار البحريني', en: 'Bahraini Dinar (BHD)', fr: 'le dinar bahreïni' }, vat: 10, tax: { ar: 'الجهاز الوطني للإيرادات NBR', en: 'the National Bureau for Revenue (NBR)', fr: "le Bureau national des revenus (NBR)" }, einv: { ar: 'ضريبة القيمة المضافة 10٪ مطبقة', en: 'VAT at 10% applies', fr: 'la TVA de 10 % est appliquée' } },
  { code: 'OM', ar: 'عمان', en: 'Oman', fr: 'Oman', inAr: 'في عمان', inEn: 'in Oman', inFr: 'à Oman', cap: { ar: 'مسقط', en: 'Muscat', fr: 'Mascate' }, cities: [{ ar: 'صلالة', en: 'Salalah', fr: 'Salalah' }, { ar: 'صحار', en: 'Sohar', fr: 'Sohar' }], cur: { ar: 'الريال العماني', en: 'Omani Rial (OMR)', fr: 'le rial omanais' }, vat: 5, tax: { ar: 'جهاز الضرائب', en: 'the Oman Tax Authority', fr: "l'Autorité fiscale omanaise" }, einv: { ar: 'ضريبة القيمة المضافة 5٪ مطبقة والفوترة الإلكترونية قادمة', en: 'VAT at 5% applies and e-invoicing is coming', fr: 'la TVA de 5 % est appliquée' } },
  { code: 'MA', ar: 'المغرب', en: 'Morocco', fr: 'Maroc', inAr: 'في المغرب', inEn: 'in Morocco', inFr: 'au Maroc', cap: { ar: 'الرباط', en: 'Rabat', fr: 'Rabat' }, cities: [{ ar: 'الدار البيضاء', en: 'Casablanca', fr: 'Casablanca' }, { ar: 'مراكش', en: 'Marrakesh', fr: 'Marrakech' }], cur: { ar: 'الدرهم المغربي', en: 'Moroccan Dirham (MAD)', fr: 'le dirham marocain' }, vat: 20, tax: { ar: 'المديرية العامة للضرائب DGI', en: 'the General Directorate of Taxes (DGI)', fr: 'la Direction générale des impôts (DGI)' }, einv: { ar: 'الضريبة على القيمة المضافة TVA 20٪ والتوجه نحو الفوترة الإلكترونية', en: 'VAT (TVA) at 20% applies, moving toward e-invoicing', fr: 'la TVA à 20 % s\'applique, avec une transition vers la facturation électronique' } },
...
const cta = (L) => P(L,
  `<p><a href="/signup"><strong>ابدأ تجربتك المجانية 10 أيام مع منصة FieldSales</strong></a> فواتير ضريبية تحصيل مخزون سيارة وتقارير لحظية من تطبيق واحد للمندوب </p>`,
...
const STRIKE_FAQ = {
  'van-sales-app': (c, L) => [
    ...
    { q: P(L, 'ما معنى مندوب كاش فان', 'Who is a van sales rep?', 'Qui est le commercial van sales ?'),
      a: P(L, 'هو المندوب الذي يحمل سيارته صباحا بكميات محددة ويمر على عملائه في خط سير مخطط ويبيع ويطبع الفاتورة فورا ويحصل نقدا أو آجلا وتظهر لوحة الإدارة آخر اليوم ما حمل وما بيع وما تبقى لكل صنف',
  ...
  'einvoicing-compliance': (c, L) => (!GCC_VAT.has(c.code) ? [] : [
    ...
    { q: P(L, 'ما الفرق بين الفاتورة الضريبية والفاتورة الإلكترونية', 'What is the difference between a tax invoice and an electronic invoice?', 'Quelle différence entre facture fiscale et facture électronique ?'),
      a: P(L, 'ليستا نوعين متقابلين الضريبية تصف مضمون الفاتورة بيانات البائع والمشتري والضريبة و الإلكترونية تصف شكل إصدارها وحفظها رقميا فالفاتورة الواحدة تكون ضريبية وإلكترونية معا ومقابل الإلكترونية هو الفاتورة الورقية لا الضريبية',
  ...
  'mobile-field-invoicing': (c, L) => (REALTIME_CLEARANCE.has(c.code) ? [
    { q: P(L, 'هل يعمل تطبيق المندوب بدون إنترنت', 'What is an offline field sales app?', "Qu'est-ce qu'une application de vente terrain hors ligne ?"),
      a: P(L, `يعمل التطبيق بلا إنترنت لتسجيل الزيارات وسندات القبض وبيانات العملاء وترفع تلقائيا فور عودة الشبكة أما الفاتورة الضريبية ${c.inAr} فتتطلب اتصالا لحظة الإصدار لأن النظام الضريبي يقوم على المقاصة اللحظية`,
  ...
  'fmcg-distribution': (c, L) => [
    { q: P(L, 'ما المقصود بالتسويق التجاري والتوزيع', 'What is trade marketing and distribution?', "Qu'est-ce que le marketing commercial et la distribution ?"),
      a: P(L, 'التسويق التجاري نشاط تسويقي موجه إلى شركاء القناة الجملة والموزعين والتجزئة لا إلى المستهلك وأدواته العروض الترويجية للقناة والحوافز والمرشندايزنغ وإدارة الفئة ووجود الصنف على الرف والتوزيع هو تنفيذ ذلك منفذا بمنفذ ولا يتحقق ما اتفق عليه إلا إذا نفذه المندوب فعلا لذا يبقى سجل الميدان زيارة وصورة وفاتورة لكل قناة هو دليل التنفيذ',
...
const faqData = (c, L, topicId) => {
  ...
  return [
    ...
    { q: P(L, `هل يعمل النظام ${c.inAr}`, `Does it work ${c.inEn}?`, `Fonctionne-t-il ${c.inFr} ?`),
      a: P(L, `نعم منصة FieldSales تدعم شركات التوزيع ${c.inAr} بعملة ${c.cur.ar} ومتطلباتها المحلية`,
...
const howToData = (c, L) => [
  { name: P(L, 'هيئ أساسك', 'Set your base', 'Préparez la base'),
    text: P(L, `أدخل منتجاتك وأسعارك وعملاءك بعملة ${c.cur.ar} وحدود ائتمانهم`,
  ...
  { name: P(L, 'جهز فريقك', 'Prepare your team', "Préparez l'équipe"),
    text: P(L, 'امنح كل مندوب حسابا بصلاحيات محددة وحمله التطبيق على جواله',
  ...
  { name: P(L, 'ابدأ من الميدان', 'Start from the field', 'Démarrez sur le terrain'),
    text: P(L, `أصدر أول فاتورة وسند قبض من ${c.cap.ar} أو أي مدينة تعمل بها`,
  ...
  { name: P(L, 'راقب لحظيا', 'Monitor live', 'Suivez en direct'),
  ...
  { name: P(L, 'حسن أسبوعيا', 'Improve weekly', 'Améliorez chaque semaine'),
...
const PRIORITY_BRIEF = {
  ...
  AE: {
    ar: `<h2>التوزيع في الإمارات أسواق متعددة بين البر والمناطق الحرة</h2>
     <p>تتوزع تجارة الجملة في الإمارات بين مناطق حرة ومناطق برية عبر سبع إمارات ودبي مركز إعادة تصدير إقليمي هذا التنوع يعني قاعدة عملاء متعددة الجنسيات وأصنافا واسعة فتحتاج إدارة الأصناف وحدود الائتمان لكل عميل إلى نظام دقيق لا جداول متفرقة </p>
     <p>ضريبة القيمة المضافة ٥٪ تتولاها الهيئة الاتحادية للضرائب والفوترة الإلكترونية Peppol في مرحلة تطبيق مرحلي تسجل منصة FieldSales كل بيع من الميدان بالدرهم الإماراتي مع فاتورة منظمة برمز QR وتتيح متابعة المخزون والتحصيل بين دبي وأبوظبي والشارقة على لوحة واحدة </p>`,
  ...
  KW: {
    ar: `<h2>التوزيع في السوق الكويتي كثافة حضرية وقيمة عالية للزيارة</h2>
     <p>يتركز التوزيع في الكويت في نطاق حضري مكتنز حول مدينة الكويت وحولي والأحمدي مع قوة شرائية مرتفعة وقيمة عالية لكل زيارة قصر المسافات يجعل عدد الزيارات المنجزة يوميا لا المسافة مقياس كفاءة المندوب </p>
  ...
  BH: {
    ar: `<h2>التوزيع في السوق البحريني جزيرة مكتنزة وطرق سريعة</h2>
     <p>صغر مساحة البحرين يجعل خطوط السير قصيرة وسريعة بين المنامة والمحرق والرفاع فيغطي المندوب منافذ أكثر في اليوم التحدي ليس المسافة بل كثافة الزيارات ودقة الفوترة والتحصيل في كل منفذ </p>
     <p>ضريبة القيمة المضافة ١٠٪ يتولاها الجهاز الوطني للإيرادات والدينار البحريني يحتسب بثلاث خانات عشرية ١٠٠٠ فلس تصدر منصة FieldSales فاتورة منظمة بالدينار البحريني برمز QR وتقريب دقيق وتعرض آخر اليوم ما حمل على السيارة وما بيع منه وما تبقى لكل صنف </p>`,
  ...
  OM: {
    ar: `<h2>التوزيع في السوق العماني مسافات طويلة وتخطيط خطوط سير</h2>
     <p>تمتد عمان جغرافيا من مسقط شمالا إلى صلالة جنوبا مرورا بصحار فتصبح المسافات وتخطيط خطوط السير عاملا رئيسيا في كلفة التوزيع وزمن التوريد تغطية المنافذ البعيدة بكفاءة تحتاج جدولة زيارات مبنية على الموقع لا على التقدير </p>
     <p>ضريبة القيمة المضافة ٥٪ يتولاها جهاز الضرائب والريال العماني يحتسب بثلاث خانات عشرية ١٠٠٠ بيسة تسجل منصة FieldSales كل زيارة بموقعها ووقتها وتطبع فاتورة منظمة بالريال العماني وتربط المبيعة بمخزون السيارة والتحصيل في خط سير واحد </p>`,
  ...
  QA: {
    ar: `<h2>التوزيع في السوق القطري سوق مكتنز وقوة شرائية مرتفعة</h2>
     <p>يتركز التوزيع في قطر حول الدوحة والريان والوكرة في نطاق جغرافي مكتنز مع قوة شرائية مرتفعة وقيمة عالية لكل منفذ قصر المسافات ينقل تركيز الكفاءة إلى جودة الزيارة ودقة الفاتورة والتحصيل لا إلى المسافة المقطوعة </p>
     <p>لا تطبق ضريبة قيمة مضافة بعد و<strong>الفوترة الإلكترونية في قطر</strong> قيد الإعداد ولم تصبح إلزامية بعد فلا يوجد حتى الآن <strong>نظام الفوترة الإلكترونية</strong> إلزامي تلزم به الشركات ومع ذلك تستعد شركات التوزيع مبكرا بإصدار <strong>الفاتورة الإلكترونية</strong> المنظمة رقميا بدل الورق ومع ذلك يبقى إصدار فواتير منظمة وكشوف حساب دقيقة بالريال القطري ضرورة إدارية لضبط الذمم تصدر منصة FieldSales الفاتورة وسند القبض من الميدان برمز QR وتضبط حدود الائتمان ومخزون السيارة على لوحة واحدة لحظية فتبدأ الفوترة المنظمة من الآن استعدادا لأي متطلبات قادمة </p>`,
...
const PRIORITY_OPS = {
  SA: {
    ar: `<p>عمليا يقيس فريق التوزيع الكبير في السعودية نفسه بنسبة تغطية المنافذ المخططة أسبوعيا وبدقة تحميل السيارة قبل الجولة تربط منصة FieldSales كل زيارة بخط سيرها وتظهر المنافذ غير المزارة ونسبة الإنجاز لكل مندوب ومنطقة </p>`,
  ...
  AE: {
    ar: `<p>يمنحك FieldSales برنامجا لإدارة المبيعات في الإمارات يربط المندوب بالإدارة لحظيا من الطلب حتى التحصيل ومع تنوع القنوات بين البر والمناطق الحرة يصبح هامش الربح لكل قناة وصنف أهم من إجمالي المبيعات تظهر منصة FieldSales المبيعات والتحصيل لكل عميل وصنف وتضبط قوائم أسعار متعددة فلا يبيع المندوب بأقل من المعتمد </p>`,
  ...
  BH: {
    ar: `<p>في سوق مكتنز الكفاءة تقاس بكثافة الزيارات اليومية ودقة المطابقة آخر اليوم لا بالمسافة تطابق منصة FieldSales مخزون السيارة مع المبيعات المسجلة فيظهر المتبقي لكل صنف وتعرض إنجاز كل مندوب على لوحة واحدة </p>`,
  ...
  OM: {
    ar: `<p>مع طول المسافات تصبح كلفة كل زيارة والالتزام بخط السير مقياسي الكفاءة تسجل منصة FieldSales خط السير الفعلي وتطابقه مع المخطط وتظهر الزمن والمسافة لكل زيارة فتتضح كلفة تغطية المناطق البعيدة </p>`,
  ...
  QA: {
    ar: `<p>في سوق عالي القيمة ومكتنز تقاس الكفاءة بجودة الزيارة واكتمال الطلب لا بعددها فقط تربط منصة FieldSales كل فاتورة بموقعها ووقتها وتعرض التحصيل وحدود الائتمان لكل عميل على لوحة لحظية </p>`,
...
const S = {
  ...
  why: (c, L) => P(L,
    `<h2>لماذا تحتاج شركات التوزيع ${c.inAr} إلى نظام مبيعات ميدانية </h2>
     <p>تدير شركات التوزيع ${c.inAr} عشرات المناديب وآلاف العملاء بين الطلبات والفواتير والتحصيل وبلا نظام موحد تضيع البيانات وتتراكم الأخطاء وتتعثر الذمم ${citiesLine(c, L)}</p>
     <p>نظام إدارة المبيعات الميدانية يربط المندوب بالإدارة لحظيا طلب فاتورة سند قبض ومخزون سيارة كلها في تطبيق واحد يعمل من الميدان </p>`,
  ...
  tax: (c, L) => P(L,
    `<h2>الالتزام الضريبي والفوترة ${c.inAr}</h2>
     <p>${taxLine(c, L)}</p>
     <p>منصة تصدر فاتورة منظمة برمز QR وطباعة حرارية تحمي شركتك من المخالفات وتبسط محاسبتك راجع دائما مستشارا ضريبيا محليا لأحدث المتطلبات </p>`,
  ...
  invoice: (c, L) => P(L,
    `<h2>الفوترة من الجوال في الميدان</h2>
     <p>يصدر المندوب الفاتورة وسند القبض من جواله في موقع العميل ويطبعها حراريا 58مم وتتزامن فورا مع الإدارة لا أوراق متفرقة ولا إدخال مزدوج </p>
     <ul><li>فاتورة ضريبية منظمة برمز QR </li><li>طباعة حرارية فورية للعميل </li><li>مزامنة لحظية مع كشف حساب العميل </li></ul>`,
  ...
  collect: (c, L) => P(L,
    `<h2>التحصيل وإدارة الذمم وكشوف الحساب</h2>
     <p>سجل كل دفعة نقد/تحويل/شيك واربطها بكشف حساب العميل ب${c.cur.ar} تلقائيا اضبط حد ائتمان لكل عميل واحصل على تنبيه فوري عند تجاوزه قبل أن يتحول الدين إلى متعثر </p>
     <p>رفع نسبة التحصيل وتقليل الديون المعلقة من أسرع مصادر تحسين السيولة لأي شركة توزيع </p>`,
  ...
  vanstock: (c, L) => P(L,
    `<h2>إدارة مخزون سيارة المندوب</h2>
     <p>سجل ما حمله كل مندوب في سيارته وتابع المتبقي بعد كل عملية بيع واكشف الفروقات فورا هذا يمنع النقص والعجز ويربط المخزون بالمبيعات لحظيا </p>`,
  ...
  gps: (c, L) => P(L,
    `<h2>تتبع المناديب وتخطيط خطوط السير</h2>
     <p>تابع مواقع المناديب وخطوط سيرهم لتنظيم التغطية وتقليل الوقت الضائع بين ${c.cap.ar} والمناطق المحيطة التتبع يرفع عدد الزيارات المنتجة يوميا </p>`,
  ...
  reports: (c, L) => P(L,
    `<h2>تقارير المبيعات والفروع المباشرة</h2>
     ...
     <p>وإذا كنت تدير أكثر من فرع أو منطقة تعرض اللوحة <strong>تقارير مبيعات وفروع مباشرة</strong> تحدث لحظيا مبيعات كل فرع ومنطقة على حدة مقارنتها ببعضها وأداء مناديب كل فرع فترى أي فرع ينمو وأيه يتأخر قبل نهاية الشهر لا بعده </p>`,
  ...
  reps: (c, L) => P(L,
    `<h2>إدارة المناديب والصلاحيات</h2>
     <p>حدد صلاحيات كل مندوب من يمنح خصما وكم نسبته من يبيع بالآجل ضبط الأدوار مدير/مشرف/محاسب يمنع التلاعب ويحمي هوامشك ${c.inAr}.</p>`,
  ...
  crm: (c, L) => P(L,
    `<h2>إدارة العملاء وشرائح الأسعار</h2>
     <p>احفظ كل عميل بموقعه وحد ائتمانه وقائمة أسعاره طبق شرائح أسعار مختلفة جملة/تجزئة/مفتاح لكل فئة عملاء وتابع كشف الحساب ب${c.cur.ar} في أي لحظة </p>`,
  ...
  features: (c, L) => P(L,
    `<h2>قائمة تحقق ما الذي يجب أن يوفره النظام </h2>
     <ul>
       <li>فاتورة ضريبية منظمة وطباعة حرارية من الجوال </li>
  ...
  howstart: (c, L) => P(L,
    `<h2>كيف تبدأ ${c.inAr} خلال دقائق </h2>
     <p>لا تحتاج إلى تركيب معقد أنشئ حسابك أضف منتجاتك وعملاءك وامنح مناديبك التطبيق يمكنك إصدار أول فاتورة متوافقة في اليوم نفسه </p>`,
  ...
  roi: (c, L) => P(L,
    `<h2>العائد على الاستثمار</h2>
     <p>وقت مندوب أكثر للبيع بدل الورق تقليل الفاقد والمرتجعات ورفع نسبة التحصيل مكاسب قابلة للقياس ب${c.cur.ar} غالبا ما تسترد تكلفة النظام سريعا </p>
     <p>احسب العائد ببساطة قارن مجموع ما توفره سنويا فاقد أقل + تحصيل أعلى + وقت بيع إضافي بتكلفة الاشتراك في معظم شركات التوزيع ${c.inAr} يسترد النظام تكلفته خلال أشهر قليلة من تقليل العجز ورفع التحصيل وحدهما </p>`,
  ...
  steps: (c, L) => P(L,
    `<h2>خطوات عملية للبدء ${c.inAr}</h2>
     <ol>
       <li><strong>هيئ أساسك </strong> أدخل منتجاتك وأسعارك وعملاءك ب${c.cur.ar} وحدود ائتمانهم </li>
       <li><strong>جهز فريقك </strong> امنح كل مندوب حسابا بصلاحيات محددة وحمله التطبيق </li>
       <li><strong>ابدأ من الميدان </strong> أصدر أول فاتورة وسند قبض من ${c.cap.ar} أو أي مدينة تعمل بها </li>
       <li><strong>راقب لحظيا </strong> تابع المبيعات والتحصيل ومخزون السيارة على لوحة واحدة </li>
       <li><strong>حسن أسبوعيا </strong> استخدم التقارير لضبط خطوط السير والأسعار والصلاحيات </li>
     </ol>`,
  ...
  benefits: (c, L) => P(L,
    `<h2>نتائج قابلة للقياس لشركتك</h2>
     <ul>
       ...
       <li>رفع نسبة التحصيل وتقليص الذمم المتعثرة عبر حدود الائتمان والتنبيهات </li>
       <li>زيادة عدد الزيارات المنتجة يوميا لكل مندوب </li>
  ...
  mistakes: (c, L) => P(L,
    `<h2>أخطاء شائعة تجنبها</h2>
     <p>الاعتماد على الورق أو جداول منفصلة يضيع البيانات ويؤخر التحصيل عدم ضبط حدود الائتمان يحول المبيعات إلى ديون وإهمال مطابقة مخزون السيارة يخفي العجز حتى يتضخم النظام الموحد يعالج هذه الثغرات الثلاث ${c.inAr} من جذورها </p>`,
  ...
  kpis: (c, L) => P(L,
    `<h2>مؤشرات مستهدفة تقيس بها نجاحك</h2>
     <p>ضع أهدافا رقمية واضحة وتابعها أسبوعيا من التقارير </p>
     <ul>
  ...
  compare: (c, L) => {
    const rows = [
      ['إصدار الفاتورة', 'دفتر ورقي ثم إدخال مسائي', 'فاتورة منظمة برمز QR من الجوال فورا',
      ...
      ['التحصيل', 'سندات مبعثرة وذمم غامضة', 'سند فوري مربوط بكشف الحساب وحد الائتمان',
      ...
      ['مخزون السيارة', 'جرد يدوي وعجز يكتشف متأخرا', 'رصيد حي بعد كل عملية وكشف فوري للفروقات',
      ...
      ['متابعة الفريق', 'اتصالات هاتفية وتقديرات', 'مواقع حية وخطوط سير وتقارير أداء',
    ...
    const title = P(L, 'قبل وبعد ماذا يتغير فعليا', 'Before and after: what actually changes?', 'Avant / après : ce qui change réellement');
  ...
  localContext: (c, L) => {
    ...
    const dAr = dec3 ? ` وتحتسب ${c.cur.ar} بثلاث خانات عشرية فيجب أن يراعي نظامك التقريب الصحيح في كل فاتورة وكشف حساب` : '';
  ...
  countryTable: (_c, L) => {
    ...
    const rows = COUNTRIES.map((k) => {
      const vat = k.vat != null ? `${k.vat}%` : P(L, 'لا تطبق', 'None', 'Aucune');
    ...
    const intro = P(L,
      'تختلف نسبة الضريبة والجهة المشرفة ومتطلبات الفوترة الإلكترونية من دولة إلى أخرى وهذا الجدول يلخصها لتعرف ما ينطبق على سوقك قبل اختيار النظام',
    ...
    const note = P(L,
      'النسب والمتطلبات إرشادية وتتغير بقرارات محلية راجعها مع مستشار ضريبي في بلدك قبل الاعتماد عليها',
...
const ANSWERS = {
  ...
  'sales-reports-analytics': (c, L) => P(L,
    `تقارير المبيعات الميدانية المفيدة تجيب عن قرار لا تعرض أرقاما أربعة تقارير تكفي معظم شركات التوزيع مبيعات كل مندوب مقابل هدفه التحصيل مقابل المستحق الأصناف الراكدة في السيارات والعملاء الذين لم تصلهم زيارة منذ مدة الشرط أن تبنى على بيانات ملتقطة لحظة الحدث في الميدان تقرير مبني على إدخال مكتبي بعد يومين يقيس ذاكرة المدخل لا الواقع`,
  ...
  'wholesale-food-distributors': (c, L) => P(L,
    `توزيع المواد الغذائية يفرض قيدا لا تعرفه القطاعات الأخرى للصنف تاريخ صلاحية فترتيب الصرف يجب أن يتبع الأقدم-أولا وإلا تحول المخزون إلى خسارة مؤكدة عمليا يعني ذلك تتبع الصنف بتشغيلته لا بكميته فقط ومعرفة ما في كل سيارة الآن وقبول المرتجعات بسبب واضح يميز التالف عن غير المطلوب لأن أحدهما مشكلة تخزين والآخر مشكلة طلب`,
  ...
  'fmcg-distribution': (c, L) => P(L,
    `توزيع السلع سريعة الدوران FMCG يدار بالتكرار لا بحجم الصفقة منافذ كثيرة فواتير صغيرة وزيارات متقاربة ما يحسم الربحية ليس هامش الصنف بل تكلفة الزيارة الواحدة عدد المنافذ التي يغطيها المندوب يوميا ونسبة الزيارات التي تنتهي بطلب فعلي لذلك تقاس هذه العمليات بمؤشري التغطية والزيارة المنتجة قبل أي مؤشر مالي آخر`,
  ...
  'mobile-field-invoicing': (c, L) => P(L,
    `الفوترة من جوال المندوب تعني إصدار الفاتورة وطباعتها أمام العميل في الزيارة نفسها بطابعة حرارية بلوتوث بعرض ٥٨ أو ٨٠ مليمترا الأثر التشغيلي ليس الطباعة بل التزامن الفاتورة تسجل باسم العميل ويخصم الصنف من السيارة ويتحدث الرصيد في اللحظة ذاتها والشرط العملي أن يعمل ذلك بلا إنترنت لأن كثيرا من المنافذ داخل مبان لا تصلها شبكة مستقرة`,
  ...
  'distribution-customer-management': (c, L) => P(L,
    `إدارة عملاء التوزيع تختلف عن CRM المبيعات في أن العميل هنا رصيد مستمر لا صفقة تغلق كل عميل يحمل قائمة أسعار خاصة به جملة أو تجزئة أو شريحة كمية وحد ائتمان يرصد تجاوزه بتنبيه فوري للإدارة ومدة سداد متفقا عليها يقاس التأخير بها حد الائتمان المعقول يشتق من الواقع لا من التقدير متوسط مشتريات العميل الشهرية مضروبا في مدة السداد مقسومة على ثلاثين`,
  ...
  'what-is-field-sales-management': (c, L) => P(L,
    `نظام إدارة المبيعات الميدانية برنامج يدير عمل الفريق خارج المكتب المندوب في الشارع والعميل في محله والبضاعة في السيارة يفعل ثلاثة أشياء لا يفعلها برنامج المحاسبة يلتقط البيانات لحظة حدوثها في الميدان ويعمل بلا إنترنت ثم يزامن ويربط كل فاتورة بمن أصدرها وأين ومتى من لا يملكه يجمع دفاتر المناديب آخر اليوم ويدخلها يدويا فيعرف ما حدث بعد يوم أو يومين لا الآن`,
  ...
  'retail-execution': (c, L) => P(L,
    `التنفيذ في نقاط البيع Retail Execution هو التأكد من أن ما اتفق عليه مع المنفذ حدث فعلا على الرف الصنف موجود السعر صحيح والعرض الترويجي مطبق يقاس بالدليل لا بالتقرير الشفهي صورة ملتقطة في الزيارة موقعها وتوقيتها مسجلان الفجوة التي يعالجها هذا المفهوم معروفة في التوزيع اتفاق تجاري سليم على الورق لا ينفذ في المنفذ ولا أحد يكتشف ذلك إلا بعد انتهاء الحملة`,
  ...
  'how-to-choose-field-sales-system': (c, L) => P(L,
    `اختيار نظام مبيعات ميدانية يحسم بخمسة أسئلة لا بقائمة ميزات هل يغطي دورتك كاملة أم يترك حلقة تدار يدويا هل يعمل بلا إنترنت هل الواجهة والفواتير بالعربية أصلا هل يتوافق مع متطلبات الفوترة في بلدك وهل السعر معلن أم تواصل معنا وقبل التوقيع شغل دورة بيع حقيقية واحدة من الطلب إلى التحصيل معظم ما يفشل بعد الشراء يظهر في هذه الدورة الواحدة`,
  ...
  'offline-field-sales-app': (c, L) => P(L,
    `العمل بلا إنترنت ليس ميزة كمالية في المبيعات الميدانية بل شرط تشغيلي كثير من المنافذ داخل أسواق ومبان لا تصلها شبكة مستقرة والمندوب لا يستطيع تأجيل البيع حتى تعود التغطية التطبيق الصحيح يصدر الفاتورة ويطبعها وينقص المخزون محليا على الجهاز ثم يرفعها عند عودة الاتصال بمعرف فريد لكل عملية يمنع تكرارها إن أعيد الإرسال وهذا المعرف لا المزامنة نفسها هو ما يمنع الفواتير المكررة`,
  ...
  'thermal-printing-invoices': (c, L) => P(L,
    `الطباعة الحرارية في الميدان تعتمد طابعة بلوتوث محمولة بعرض ٥٨ أو ٨٠ مليمترا تطبع بالحرارة على ورق حساس بلا حبر ما يهم عمليا ثلاثة أن يطبع النص العربي بشكل صحيح لا معكوسا أو متقطعا أن يكون رمز QR واضحا بما يكفي ليقرأ من الجوال وأن تعمل الطباعة بلا إنترنت لأن الطابعة متصلة بالجهاز مباشرة ورق ٨٠ مليمترا أوضح للفواتير متعددة الأصناف و٥٨ أخف حملا`,
  ...
  'digital-transformation-distribution': (c, L) => P(L,
    `التحول الرقمي في شركات التوزيع لا يبدأ بالنظام بل بتحديد الحلقة التي تدار على الورق وتكلف أكثر عادة الفاتورة المكتوبة يدويا أو مخزون السيارة المجهول حتى نهاية الشهر أو رصيد العميل الذي لا يعرفه إلا المحاسب الترتيب العملي أن ترقمن حلقة واحدة حتى تستقر ثم التالية لأن تحويل كل شيء دفعة واحدة يخلق مقاومة من المناديب وفوضى بيانات في الشهر الأول`,
  ...
  'route-planning-sales': (c, L) => P(L,
    `تخطيط خط السير يعني تثبيت أي منفذ يزار في أي يوم وبأي تكرار بدل ترك الترتيب لاجتهاد المندوب اليومي الفائدة ليست تقصير المسافة وحدها بل انتظام التغطية العميل الذي يزار في موعد ثابت يجهز طلبه والعميل المنسي يظهر في تقرير لم تصله زيارة منذ المقارنة بين الخط المخطط والمسار الفعلي المسجل بGPS هي ما يحول الخطة من ورقة إلى أداة`,
  ...
  'whatsapp-sales-followup': (c, L) => P(L,
    `واتساب هو قناة التواصل الفعلية بين موزعي المنطقة وعملائهم لكنه يفشل كأداة إدارة لسبب واحد الرسالة لا تسجل في حساب العميل الاستخدام السليم أن يبقى واتساب قناة التنبيه تأكيد طلب تذكير باستحقاق إرسال كشف حساب بينما يبقى مصدر الحقيقة هو النظام ما يتفق عليه في محادثة ولا يسجل كطلب أو سند لا وجود له عند المراجعة بعد شهر`,
...
function topicVat(c, L) {
  if (!c.vat) return P(L,
    `تختلف متطلبات الفوترة بين الدول فتحقق من الساري لدى ${c.tax.ar} قبل اعتماد أي إعداد`,
  ...
  return P(L,
    `وتحتسب ضريبة القيمة المضافة ${c.inAr} بنسبة ${c.vat}% وتظهر مفصلة في الفاتورة مع مراجعة الساري لدى ${c.tax.ar}.`,
...
const LOCAL_ANCHOR = {
  ...
  'sales-rep-management': (c, L) => P(L,
    `ويقاس أداء المندوب ${c.inAr} بمبيعاته وتحصيله ب${c.cur.ar} مقابل هدف معلن لا بعدد الساعات التي قضاها في الشارع`,
  ...
  'collection-receivables': (c, L) => P(L,
    `وتحسب الأرصدة ${c.inAr} ب${c.cur.ar} ضمن مدة السداد المتفق عليها مع كل عميل على حدة لا بمدة موحدة للجميع`,
  ...
  'gps-rep-tracking': (c, L) => P(L,
    `وفي مدن مثل ${c.cap.ar} و${c.cities[0].ar} حيث يلتهم الزحام ساعات اليوم يكشف الفصل بين زمن التنقل وزمن الزيارة أين يذهب الوقت فعلا`,
  ...
  'van-stock-inventory': (c, L) => P(L,
    `وتقوم الفروقات ب${c.cur.ar} لتصير رقما يقارن بتكلفة الضبط اليومي فيتخذ القرار على أساس مقارنة لا انطباع`,
  ...
  'sales-reports-analytics': (c, L) => P(L,
    `وتعرض المبالغ ${c.inAr} ب${c.cur.ar} حتى تقارن الفترات مباشرة بلا تحويل يدوي يدخل الخطأ`,
  ...
  'wholesale-food-distributors': (c, L) => P(L,
    `و${c.inAr} يشتد أثر ذلك في المواسم التي يقفز فيها الطلب فجأة فتحمل السيارات فوق المعتاد ويصعب تتبع ما خرج منها`,
  ...
  'mobile-field-invoicing': (c, L) => P(L,
    `وتصدر الفاتورة ${c.inAr} ب${c.cur.ar} وفق ما يسري لدى ${c.tax.ar} وقت الإصدار`,
...
export function getArticle(slug, L) {
  ...
  const intro = P(L,
    `<p>${t} أصبح ضرورة لكل شركة توزيع تريد النمو بكفاءة في هذا الدليل من <strong>FieldSales</strong> نشرح كيف تدير مبيعاتك الميدانية باحتراف من الطلب إلى الفاتورة إلى التحصيل مع مراعاة متطلبات ${topic.cs ? c.ar : 'السوق العربي'} المحلية </p>
     <p>سواء كنت موزعا للمواد الغذائية أو المشروبات أو مستلزمات التجزئة ستجد هنا خطوات عملية وأمثلة محلية تساعدك على رفع كفاءة مناديبك وتحصيلك ومبيعاتك مدعومة بالأرقام لا التخمين </p>`,
