    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" dir="rtl">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <h2 className="text-lg font-bold text-gray-800">{customer ? 'تعديل عميل' : 'إضافة عميل جديد'}</h2>
        ...
        <form onSubmit={handleSubmit(onSave)} className="p-6 space-y-6">
          ...
          {/* Address */}
          <div>
            <h3 className="text-sm font-semibold text-gray-500 mb-3 uppercase">العنوان</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
          ...
          {/* Financial */}
          <div>
            <h3 className="text-sm font-semibold text-gray-500 mb-3 uppercase">البيانات المالية</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="label">الحد الائتماني (ريال)</label>
                <input className="input" type="number" min="0" step="0.01" {...register('creditLimit', { valueAsNumber: true })} />
              </div>
              <div>
                <label className="label">فترة السداد (يوم)</label>
