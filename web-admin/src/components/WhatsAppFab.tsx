...
export default function WhatsAppFab() {
  ...
  const label = 'تحدّث معنا على واتساب';
  return (
    <a
      href={waHref(pathname, { lang: document.documentElement.lang || 'ar' })}
      target="_blank"
    ...
    >
      ...
      <svg width="27" height="27" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
