      ...
      <div className="w-full max-w-md bg-white rounded-2xl border border-[#E9E1D3] shadow-sm p-8 text-center">
        ...
        {state === 'loading' && (
          <>
            ...
            <p className="text-[#6E6557]">جارٍ تأكيد بريدك…</p>
          </>
        )}
        ...
        {state === 'ok' && (
          <>
            ...
            <h1 className="text-xl font-bold text-[#1F1A13]">تم تأكيد بريدك الإلكتروني ✅</h1>
            <p className="text-[#6E6557] text-sm mt-2">شكراً لك. حسابك مفعّل بالكامل الآن.</p>
            <Link to="/app" className="btn-primary mx-auto mt-6 inline-flex">الذهاب للوحة التحكم <ArrowLeft size={16} className={dir === 'rtl' ? '' : 'rotate-180'} /></Link>
          </>
        )}
        ...
        {state === 'fail' && (
          <>
            ...
            <h1 className="text-xl font-bold text-[#1F1A13]">رابط التأكيد غير صالح</h1>
            <p className="text-[#6E6557] text-sm mt-2">انتهت صلاحية الرابط أو أنه غير صحيح. سجّل الدخول واطلب إعادة إرسال رابط التأكيد.</p>
            <Link to="/login" className="btn-primary mx-auto mt-6 inline-flex">تسجيل الدخول</Link>
          </>
        )}
      </div>
    </div>
