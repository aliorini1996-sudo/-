...
export default function LandingPage() {
  ...
  useSeo(lang === 'en' ? {
    ...
    description: 'فيلد سيلز نظام سعودي لإدارة مبيعات مناديب التوزيع: فواتير ZATCA، تحصيل وإدارة الذمم، سندات قبض، مخزون سيارة المندوب، وتتبّع GPS. جرّبه مجاناً 10 أيام.',
