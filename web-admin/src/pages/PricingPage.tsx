...
const T: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    sub: 'السعر لكل شركة لا لكل مستخدم إضافة مندوب ضمن حد باقتك لا تزيد فاتورتك',
    ...
    calcTitle: 'احسب الفرق بين نموذجي التسعير',
    calcSub: 'أغلب البدائل تسعر لكل مندوب أدخل عدد مناديبك وقارن الفاتورة السنوية',
    reps: 'عدد المناديب',
    perUserPrice: 'سعر المندوب الواحد شهريا لدى البديل ر.س',
