...
const TOOLS = [
  { id: 'commission', title: 'حاسبة عمولة المندوب المتدرّجة', icon: Calculator,
    desc: 'شرائح عمولة بأرضية وسقف وخصم المرتجعات — بدل جداول Excel الهشّة.' },
  { id: 'van', title: 'تسوية عهدة سيارة المندوب', icon: Truck,
    desc: 'طابق حمولة السيارة آخر اليوم واكشف العجز بالصنف وقيمته.' },
  { id: 'reps', title: 'كم مندوباً تحتاج؟', icon: Users,
    desc: 'حجّم فريقك الميداني قبل التوظيف أو الشراء، بحساسية ±٢٠٪.' },
  { id: 'aging', title: 'أعمار الدين وحدّ الائتمان', icon: Wallet,
