...
const T: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    subtitle: 'كم تخسر شركتك شهريا بإدارة المناديب على الورق والواتساب أدخل أرقامك وشاهد الحقيقة',
    reps: 'عدد المناديب',
    invPerDay: 'متوسط فواتير المندوب يوميا',
    avgInvoice: 'متوسط قيمة الفاتورة',
    workDays: 'أيام العمل شهريا',
    cashPct: 'نسبة البيع النقدي والتحصيل الميداني',
    method: 'كيف تدار مبيعاتك اليوم',
    ...
    leakTitle: 'تسريبك الشهري المقدر',
    leakYear: 'أي ما يقارب {y} سنويا 😱',
    b1: 'فواتير مفقودة وأخطاء تسعير',
    b2: 'تحصيل نقدي غير موثق ومتأخر',
    b3: 'عجز وفروقات مخزون السيارات',
    b4: 'وقت مناديب ضائع في الإدخال اليدوي',
    note: 'نسب تحفظية من متوسطات قطاع التوزيع الواقع غالبا أعلى',
    cta: 'أوقف التسريب جرب Field Sales مجانا',
    ctaSub: '10 أيام مجانا بلا بطاقة ائتمان جاهز خلال دقائق',
    share: 'شارك النتيجة واتساب',
    shareText: '😱 حسبت تسريب الإيرادات في شركة التوزيع نظام الورق والواتساب قد يكلف {m} شهريا {y} سنويا \nاحسب تسريبك مجانا هنا',
    disclaimer: 'الحاسبة تقديرية للتوعية ولا تعد وعدا بنتائج النسب 1.2% أخطاء فوترة 2.5% من النقدي تحصيل غير موثق 1% عجز مخزون 1.5% وقت ضائع تنخفض بحسب طريقة إدارتك الحالية',
    guide: '📖 دليل كم تخسر شركات التوزيع سنويا وكيف تغلق التسريب',
    tryInvoice: '🧾 جرب أيضا مولد الفاتورة الضريبية المجاني',
  },
  en: {
  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: (lang === 'en' ? [
        ...
        { q: 'كم تخسر شركات التوزيع بالإدارة الورقية', a: 'الشركات التي تدير مناديبها بالورق أو الواتساب تسرب عادة 3-6% من إيراداتها بين فواتير مفقودة وأخطاء تسعير وتحصيل نقدي غير موثق وعجز مخزون سيارات ووقت ضائع في الإدخال اليدوي' },
