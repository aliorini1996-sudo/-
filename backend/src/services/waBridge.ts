...
export const DEFAULT_DRAFT = [
  'مرحبا {{name}} 👋',
  '',
  'أنا علي من Field Sales نظام عربي لإدارة مبيعات المناديب والتوزيع فواتير تحصيل وذمم مخزون سيارة المندوب تتبع GPS',
  '',
  '{{angle}}',
  '',
  'حاب أعرف كيف تديرون مناديبكم حاليا',
  'تجربة مجانية بلا بطاقة fieldsa net',
  '',
  'لإيقاف الرسائل رد بكلمة إيقاف',
].join('\n');
