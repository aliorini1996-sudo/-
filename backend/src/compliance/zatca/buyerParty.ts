// ============================================================================
// ZATCA المرحلة الثانية (Z5.1a) — تصنيف المشتري وطرفه في المستند، مكتفٍ بذاته (يستورد validators.ts وحده)
// ----------------------------------------------------------------------------
// z5_plan §3 Z5.1a: نسخة سلوكية مطابقة لـ classifySubtype وmapBuyerParty في mapInvoice.ts (ذاك يستورد المبالغ والوقت فلا يُنسخ
// للواجهة). mapInvoice.ts لم يُمسّ (وحدة حيّة): اختبار buyerData.test.ts يثبت تطابق النتيجتين على كل التجهيزات، فالقائمة الناقصة
// وبطاقة العميل تحكمان بما سيحكم به الإصدار (Z5.2).
// ⚠️ يُنسخ حرفياً (بعد هذا الرأس) إلى web-admin/src/lib/zatca/buyerParty.ts — اختبار الحارس هناك يفشل عند أي فرق.
// ============================================================================
